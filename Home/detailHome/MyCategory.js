    ...
    <View style={styles.container}>
      <View style={{ flexDirection: "row" }}>
        ...
        >
          ...
          />
          <Text style={styles.titleCateText}>Bóng đá</Text>
        </TouchableOpacity>
        <TouchableOpacity
          style={styles.test1}
          onPress={() => {
        ...
        >
          ...
          />
          <Text style={styles.titleCateText}>Quần vợt</Text>
        </TouchableOpacity>
        <TouchableOpacity
          style={styles.test1}
          onPress={() => {
        ...
        >
          ...
          />
          <Text style={styles.titleCateText}>Bóng rổ</Text>
        </TouchableOpacity>
        <TouchableOpacity
          style={styles.test1}
          onPress={() => {
        ...
        >
          ...
          />
          <Text style={styles.titleCateText}>Cầu Lông</Text>
        </TouchableOpacity>
      </View>
      <View style={{ flexDirection: "row" }}>
        <TouchableOpacity
        ...
        >
          ...
          />
          <Text style={styles.titleCateText}>Bóng bàn</Text>
        </TouchableOpacity>
        <TouchableOpacity
          style={styles.test1}
          onPress={() => {
        ...
        >
          ...
          />
          <Text style={styles.titleCateText}>Bóng chuyền</Text>
        </TouchableOpacity>
        <TouchableOpacity
          style={styles.test1}
          onPress={() => {
        ...
        >
          ...
          />
          <Text style={styles.titleCateText}>Trượt Ván</Text>
        </TouchableOpacity>
        <TouchableOpacity
          style={styles.test1}
          onPress={() => {
        ...
        >
          ...
          />
          <Text style={styles.titleCateText}>Đấm bốc</Text>
        </TouchableOpacity>
      </View>
    </View>
  );
